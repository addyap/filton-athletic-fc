...
function LatestNewsBanner() {
  ...
  return (
    <div className="relative z-10 border-b border-white/10 bg-black/20 backdrop-blur-[1px]">
      ...
      >
        <span className="inline-flex shrink-0 items-center gap-1.5 rounded-full bg-[#a9e0b8] px-3 py-1 text-xs font-bold uppercase tracking-wide text-[#0b2d52]">
        ...
        <Link
          to="/#news"
          className="hidden shrink-0 text-sm font-semibold text-[#a9e0b8] hover:text-white sm:inline"
        >
          All news &rarr;
        </Link>
      </div>
